...
read live from the schema (e.g. --ss, --sn, --ansp/--no-ansp, --correct-only):
    pyscript BlurXTerminator.py --sn 0.5 --ansp
...
#         Also refresh the built-in fallback schema to rc-astro 2.5.0's BXT
#         parameters: the auto-nonstellar control is now --ansp ("Automatic PSF")
#         not --ansr, and the manual radius is --nsd ("PSF Diameter") not --nsr.
#         The live schema already drives the real UI/command line, so this only
#         corrects the offline fallback and the CLI usage examples.
...
DEFAULT_SCHEMA = {
    ...
    "parameters": [
        ...
        {"label": "Sharpen Stars", "name": "ss", "flag": "--ss",
         ...
         "type": "float", "precision": 2, "default": 0.5, "min": 0.0, "max": 0.7},
        ...
        {"label": "PSF Diameter", "name": "nsd", "flag": "--nsd",
         "description": "Manual nonstellar PSF diameter (must be 0.0 when "
                        "auto-nonstellar-psf is true)",
         "type": "float", "precision": 1, "default": 0.0, "min": 0.0, "max": 8.0,
         "disabledIf": "ansp", "disabledValue": 0.0, "unit": "pixels"},
        {"label": "Automatic PSF", "name": "ansp", "flag": "--ansp",
         "description": "Estimate the nonstellar PSF automatically from stars in "
                        "the image",
         "type": "bool", "default": True},
        {"label": "Sharpen Nonstellar", "name": "sn", "flag": "--sn",
         "description": "Amount of nonstellar sharpening",
         "type": "float", "precision": 2, "default": 0.5, "min": 0.0, "max": 1.0},
    ],
    "groups": [
    ...
    "modes": [
        {"flag": "--correct-only", "name": "correctOnlyMode", "label": "Correct Only",
         ...
         "pins": {"ansp": True, "ash": 0.0, "nsd": 0.0, "sn": 0.0, "ss": 0.0}},
    ],
}
